...
public class Task2Project {
	...
	public static void main(String[] args) {
		...
		/*
		 * Using Scanner create an array of countries. When an array is created for
		 * countries and capitals,
		 * then retrieve all values from it and while retrieving those values print capital
